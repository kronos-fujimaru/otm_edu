...
use App\Http\Requests\Manager\MessageRequest;
...
class MessagesController extends ManagerAuthController
{
    ...
    public function store(MessageRequest $request)
    {
        ...
        if ($topic->fromCompany->id == $user->company->id
            ...
            $message->user_id = $manager->user_id;
            ...
            return redirect("/manager/topics/{$message->topic_id}")
